package com.example.demo.commands.saga;
import com.Userservice.Commonservice.commands.GetUserPaymentDetailsQuery;
import com.Userservice.Commonservice.commands.commands.*;
import com.Userservice.Commonservice.commands.events.*;
import com.example.demo.commands.events.OrderCreatedEvent;
...
public class OrderProcessingSaga {
    ...
    private void handle(OrderCreatedEvent event) {
        ...
        ValidatePaymentCommand validatePaymentCommand
                ...
                .builder().cardDetails(user.getCardDetails())
